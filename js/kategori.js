// kategori.js - JavaScript untuk halaman kategori
class KategoriPage {
    constructor() {
    ...
    displayProducts() {
        ...
        if (loadMoreButton) {
            loadMoreButton.style.display = 
                this.displayedProducts < this.filteredProducts.length ? 'block' : 'none';
        }
    }
    ...
    filterByCategory(categoryName) {
        ...
        // Update UI
        const sectionTitle = document.querySelector('#produkSection .section-title');
        if (sectionTitle) {
            sectionTitle.textContent = categoryName;
            sectionTitle.innerHTML += ` <span class="filter-active">${this.getCategoryProductCount(categoryName)} produk</span>`;
        }
    ...
    getCategoryProductCount(categoryName) {
        return BARANG_DATA.produk.filter(p => p.kategori === categoryName).length;
    }
    ...
    resetFilters() {
        ...
        const sectionTitle = document.querySelector('#produkSection .section-title');
        if (sectionTitle) {
            sectionTitle.textContent = 'SEMUA PRODUK';
        }
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <button class="btn-product" onclick="kategoriPage.addToCart(${product.id})" style="margin-top: 20px;" ${product.stok === 0 ? 'disabled' : ''}>
                                    <i class="fas fa-cart-plus"></i> 
