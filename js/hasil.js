// hasil.js - JavaScript untuk halaman hasil pencarian
class HasilPencarian {
    ...
    initializeEventListeners() {
        ...
        document.getElementById('searchInput')?.addEventListener('keypress', (e) => {
            if (e.key === 'Enter') {
                window.location.href = `hasil.html?q=${encodeURIComponent(e.target.value)}`;
            }
        });
    ...
    initializeSearch() {
        // Prefill search inputs with current query
    ...
    loadSearchResults() {
        ...
        if (this.query) {
            products = BARANG_DATA.cariProduk(this.query);
        } else {
            products = BARANG_DATA.produk;
        }
        ...
        // Update result count
        if (resultCount) {
            resultCount.textContent = `${this.filteredProducts.length} produk ditemukan`;
        }

        // Tampilkan no results jika tidak ada produk
        if (noResults) {
    ...
    displayResults(products) {
        ...
        resultsContainer.innerHTML = products.map(product => this.createProductHTML(product)).join('');
    }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="btn-product" onclick="hasilPage.addToCart(${product.id})" 
                                ${isSoldOut ? 'disabled' : ''}>
                        ...
                        <div class="product-actions">
                            ...
                            <button class="btn-link" onclick="hasilPage.showProductDetail(${product.id})">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <button class="btn-product" onclick="hasilPage.addToCart(${product.id})" style="margin-top: 20px;" ${product.stok === 0 ? 'disabled' : ''}>
                                    <i class="fas fa-cart-plus"></i> 
...
// Inisialisasi halaman hasil pencarian
let hasilPage;
